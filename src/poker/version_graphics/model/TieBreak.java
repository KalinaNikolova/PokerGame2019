...
public class TieBreak {
	...
	valueList2=HandType.getValueList(deck2); 
        ...
        case "Straight":
        case "StraightFlush": 		//  higher rank wins, If both Straights contain cards of the same rank
        ...
        case "OnePair":  	 // first compare the pair, in case of a tie compare the rest
        case "ThreeOfAKind": 
        case "FourOfAKind":   { 
	...
	//HandType.evaluateHand(players.get(i).getCards()); 
